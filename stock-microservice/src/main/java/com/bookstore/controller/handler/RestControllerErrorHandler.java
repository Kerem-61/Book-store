package com.bookstore.controller.handler;
...
import com.bookstore.dto.error.ErrorResponse;
...
public class RestControllerErrorHandler {
	...
	public ErrorResponse handleCustomerNotFoundException(StockNotFoundException e) {
		return new ErrorResponse("Customer Rest API", e.getMessage());
	}

	@ExceptionHandler(StockAlreadyExistException.class)
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public ErrorResponse handleCustomerAlreadyExistException(StockAlreadyExistException e) {
		return new ErrorResponse("Customer Rest API", e.getMessage());
	}
